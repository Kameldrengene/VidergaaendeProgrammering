 ...
 *  Compilation:  javac Lektion1.complex.Complex.java
 *  Execution:    java Lektion1.complex.Complex
 *
 *  Data type for complex numbers.
 *
 *  The data type is "immutable" so once you create and initialize
 *  a Lektion1.complex.Complex object, you cannot change it. The "final" keyword
 *  when declaring re and im enforces this rule, making it a
 *  compile-time error to change the .re or .im instance variables after
 *  they've been initialized.
 *
 *  % java Lektion1.complex.Complex
 *  a            = 5.0 + 6.0i
 *  b            = -3.0 + 4.0i
 *  Re(a)        = 5.0
 *  Im(a)        = 6.0
...
public class Complex implements IComplex{
    ...
    // return a string representation of the invoking Lektion1.complex.Complex object
    ...
    // return a new Lektion1.complex.Complex object whose value is the complex sine of this
    public Complex sin() {
        return new Complex(Math.sin(re) * Math.cosh(im), Math.cos(re) * Math.sinh(im));
    }

    // return a new Lektion1.complex.Complex object whose value is the complex cosine of this
    public Complex cos() {
